---
name: kapruka-brand-identity
description: Provides the single source of truth for Kapruka brand guidelines, design tokens, technology choices, and voice/tone for the AI Shopping Agent project. Use this skill whenever generating UI components, styling applications, writing copy, or creating user-facing assets to ensure brand consistency with Kapruka.
---
...
This skill defines the core constraints for visual design and technical implementation for the Kapruka AI Shopping Agent. You must adhere to these guidelines strictly to maintain consistency with the Kapruka brand.
